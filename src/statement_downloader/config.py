...
BROKERAGES: dict[str, BrokerageConfig] = {
    ...
    "fidelity": BrokerageConfig(
        ...
        statements_url="https://digital.fidelity.com/ftgw/digital/portfolio/statements",
    ),
    ...
    "etrade": BrokerageConfig(
        ...
        folder_name="ETrade",
        login_url="https://us.etrade.com/e/t/user/login",
        statements_url="https://us.etrade.com/etx/pxy/my-account/documents",
    ),
    "vanguard": BrokerageConfig(
        ...
        statements_url="https://personal.vanguard.com/us/XHTML/com/vanguard/retail/web/view/AccountDocumentsView.xhtml",
    ),
    "webull": BrokerageConfig(
        ...
        statements_url="https://www.webull.com/edocs/",
    ),
